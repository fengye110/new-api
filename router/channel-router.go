...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/:id/test-all-keys", permission: authz.ChannelOperate, handler: controller.TestAllKeys},
	...
	{method: http.MethodPost, path: "/codex/login/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartCodexHeadlessLogin},
	{method: http.MethodGet, path: "/codex/login/:login_id", permission: authz.ChannelSensitiveWrite, handler: controller.GetCodexHeadlessLogin},
	{method: http.MethodPost, path: "/:id/codex/credentials/import", permission: authz.ChannelSensitiveWrite, handler: controller.ImportCodexChannelCredential},
