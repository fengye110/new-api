	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/subscription/:id/disable", middleware.CriticalRateLimit(), controller.DisableUserSubscription)
				selfRoute.POST("/subscription/:id/enable", middleware.CriticalRateLimit(), controller.EnableUserSubscription)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/self/:id/disable", middleware.CriticalRateLimit(), controller.DisableUserSubscription)
			subscriptionRoute.POST("/self/:id/enable", middleware.CriticalRateLimit(), controller.EnableUserSubscription)
			subscriptionRoute.DELETE("/self/:id", middleware.CriticalRateLimit(), controller.DeleteUserSubscription)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.DELETE("/access-groups/:id", controller.AdminDeleteSubscriptionAccessGroup)
			subscriptionAdminRoute.GET("/access-groups/:id/users", controller.AdminListSubscriptionAccessGroupUsers)
			subscriptionAdminRoute.GET("/access-groups/:id/plans", controller.AdminListSubscriptionAccessGroupPlans)
			subscriptionAdminRoute.DELETE("/access-groups/:id/users/:user_id", controller.AdminRemoveUserFromSubscriptionAccessGroup)
			subscriptionAdminRoute.DELETE("/access-groups/:id/plans/:plan_id", controller.AdminRemovePlanFromSubscriptionAccessGroup)
			...
			subscriptionAdminRoute.GET("/users/:id/access-groups", controller.AdminGetUserSubscriptionAccessGroups)
			subscriptionAdminRoute.PUT("/users/:id/access-groups", controller.AdminReplaceUserSubscriptionAccessGroups)
