...
func truncateTables(t *testing.T) {
	...
	t.Cleanup(func() {
		...
		DB.Exec("DELETE FROM user_relay_groups")
		...
		DB.Exec("DELETE FROM subscription_plan_access_groups")
		DB.Exec("DELETE FROM user_subscription_access_groups")
		DB.Exec("DELETE FROM subscription_access_groups")
