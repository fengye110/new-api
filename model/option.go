...
func InitOptionMap() {
	...
	common.OptionMap["ChannelKeySecureVerificationEnabled"] = strconv.FormatBool(common.ChannelKeySecureVerificationEnabled)
	...
	common.OptionMap["DefaultGroupForNewUser"] = common.DefaultGroupForNewUser
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "ChannelKeySecureVerificationEnabled":
			common.ChannelKeySecureVerificationEnabled = boolValue
	...
	case "DefaultGroupForNewUser":
		common.DefaultGroupForNewUser = strings.TrimSpace(value)
