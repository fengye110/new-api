...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&SubscriptionAccessEmailRuleGroup{},
		&CustomOAuthProvider{},
		&UserOAuthBinding{},
		&PerfMetric{},
		&SystemInstance{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&SubscriptionAccessEmailRule{}, "SubscriptionAccessEmailRule"},
		{&SubscriptionAccessEmailRuleGroup{}, "SubscriptionAccessEmailRuleGroup"},
